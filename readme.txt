...
* Stay in current folder after drag-drop instead of navigating away

= 1.0.12 =
* Fix media modal folder filtering using ajaxPrefilter

= 1.0.11 =
* Also navigate to All Media after creating folders

= 1.0.10 =
* Navigate to All Media after drag-drop (initial load filtering unreliable)
* Folder filtering works when clicking folders after page load

= 1.0.9 =
* Fix AJAX filtering - use $.ajaxPrefilter instead of ajaxSend
* ajaxSend fires too late to modify request data

= 1.0.8 =
* After drag-drop, navigate to target folder instead of reloading current view
* Simpler and better UX - you see your moved items immediately

= 1.0.7 =
* Fixed unreliable folder filtering - use server-side media_view_settings filter
* Inject folder filter directly into WordPress media library initialization

= 1.0.6 =
* Fixed unreliable folder filtering on page load
* Hook AJAX filter earlier and force refresh when folder filter is active
